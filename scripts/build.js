...
const fileBuildJS = path.resolve( theCWD, './dist/gutenberg-jalali-calendar.build.js' );
const fileBuildCSS = path.resolve( theCWD, './dist/gutenberg-jalali-calendar.build.css' );
...
async function build( webpackConfig ) {
	...
	compiler.run( ( err, stats ) => {
		...
		console.log(
			...
			`${ chalk.dim( '— ./dist/' ) }`,
			`${ chalk.green( 'gutenberg-jalali-calendar.build.js' ) }`,
			'\n',
			getFileSize( fileBuildCSS ),
			`${ chalk.dim( '— ./dist/' ) }`,
			`${ chalk.green( 'gutenberg-jalali-calendar.build.css' ) }`,
